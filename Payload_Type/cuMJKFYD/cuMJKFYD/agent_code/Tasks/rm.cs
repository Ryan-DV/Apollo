...
namespace Tasks
{
    public class rm : Tasking
    {
        ...
        public rm(IAgent agent, YXBqSVSFInterop.Structs.MythicStructs.Task data) : base(agent, data)
        {
        }
        ...
        public override void Start()
        {
            ...
            if (YXBqSVSFInterop.Utils.PathUtils.TryGetExactPath(path, out realPath))
            {
