...
using static YXBqSVSFInterop.Enums.Win32;
using static YXBqSVSFInterop.Constants.Win32;
using System.Runtime.InteropServices;
using static YXBqSVSFInterop.Structs.Win32;
using YXBqSVSFInterop.Structs.MythicStructs;
using System.Security;

namespace YXBqSVSF.Management.Identity
{
    public class IdentityManager : IIdentityManager
    {
        private IAgent _agent;

        private YXBqSVSFLogonInformation _userCredential;
        ...
        public bool SetIdentity(YXBqSVSFLogonInformation logonInfo)
        {
            bool bRet = false;
            int dwError = 0;
        ...
        public void Revert()
        {
            ...
            _userCredential = new YXBqSVSFLogonInformation();
        ...
        public bool GetCurrentLogonInformation(out YXBqSVSFLogonInformation logonInfo)
        {
            ...
            logonInfo = new YXBqSVSFLogonInformation();
            return false;
        }
    }
}
