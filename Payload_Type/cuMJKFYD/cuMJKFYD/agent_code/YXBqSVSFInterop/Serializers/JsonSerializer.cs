...
namespace YXBqSVSFInterop.Serializers
{
    public class JsonSerializer : ISerializer
    {
        ...
        public JsonSerializer()
        {
            ...
            //{
            //    if (t.FullName.StartsWith("YXBqSVSFInterop.Structs.MythicStructs") || t.FullName.StartsWith("YXBqSVSFInterop.Structs.YXBqSVSFStructs"))
            //    {
            //        _knownTypes.Add(t);
            //    }
            //}
