using YXBqSVSFInterop.Classes.Collections;
...
namespace YXBqSVSFInterop.Structs.YXBqSVSFStructs
{
    ...
    public struct YXBqSVSFTokenInformation
    {
        public IntPtr Token;
    ...
    public struct YXBqSVSFLogonInformation
    {
        ...
        public YXBqSVSFLogonInformation(string username, string password, string domain = ".", bool netOnly=false)
        {
