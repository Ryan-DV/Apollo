...
using YXBqSVSF;
using YXBqSVSF.Jobs;
using YXBqSVSF.Tasks;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace YXBqSVSFTests
{
    [TestClass]
    public class TaskTests
    {
        ...
        public void ProcessTest()
        {
            ...
            YXBqSVSF.Tasks.Process.Execute(job, agent);
            // Ensure the task is marked as complete
            Assert.IsTrue(task.status == "complete");
        ...
        public void ProcessListTest()
        {
            ...
            Job job = new Job(task, null);
            YXBqSVSF.Tasks.ProcessList.Execute(job, null);
            // Ensure the task is marked as complete
            Assert.IsTrue(task.status == "complete");
        ...
        public void RemoveTest()
        {
            ...
            Job job = new Job(task, null);
            YXBqSVSF.Tasks.Remove.Execute(job, null);
            // Ensure the task is marked as complete
            Assert.IsTrue(task.status == "complete");
            // Ensure we have the correct type of output
